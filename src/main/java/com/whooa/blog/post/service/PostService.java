...
public interface PostService {
	...
	public abstract PageResponse<PostResponse> findAll(PageQueryString pageDto);
	public abstract PageResponse<PostResponse> findAllByCategoryId(PageQueryString pageDto, Long id);
