...
public class PostDto {
	...
	public static class Response {
		...
		public Response(final Long id, final String title, final String description, final String content) {
			this.id = id;
			this.title = title;
			this.description = description;
			this.content = content;
		...
		@Override
		public String toString() {
			return "Response [id=" + id + ", title=" + title + ", description=" + description + ", content=" + content
					+ "]";
		}
	}
}